...
:::{grid-item-card} Mario Alejandro Bravo O.
:class-body: text-center
:class-header: bg-light text-center
```{image} _static/images/Mario.JPG
:height: 100
:class: rounded
...
**Objetivo General**
Capacitar al estudiante en el diseño, desarrollo e implementación de soluciones analíticas de extremo a extremo, integrando modelos avanzados de aprendizaje profundo y construyendo pipelines robustos para resolver problemas complejos y escalar modelos en entornos reales.
